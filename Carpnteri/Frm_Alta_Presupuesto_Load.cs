...
namespace Carpnteri
{
    public partial class Frm_Alta_Presupuesto_Load : Form
    {
        private HelperDB gestor;
        private Presupuesto nuevo;
        public Frm_Alta_Presupuesto_Load()
        {
            InitializeComponent();
            gestor = new HelperDB();
            CargarProductos();
        ...
        private void Frm_Alta_Presupuestos_Load(object sender, EventArgs e)
        {
            ProximoPresupuesto();
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            dgvDetalles.Rows.Add(new object[] { item.Row.ItemArray[0], item.Row.ItemArray[1], item.Row.ItemArray[2] });
